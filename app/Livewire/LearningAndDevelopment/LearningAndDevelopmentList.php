...
class LearningAndDevelopmentList extends Component
{
    ...
    {
        $personalInformation = PersonalInformation::find($this->personalInformationId);
        $learningAndDevelopments =  $personalInformation->learningAndDevelopment()->latest()->paginate(5);
        return view('livewire.learning-and-development.learning-and-development-list', compact('learningAndDevelopments'));
    }
